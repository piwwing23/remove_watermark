...
#------------[ FOR LOGIN HEADRES FOR CHECKING IDS]--------------#
j = 'x'
i = 'mbasic'
a = 'm'
b = 'g'
...
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m DEVELOPER :   Dark_Devil
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m TOOLS     :   FILE & RANDOM
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m GITHUB    :   Dark_Devil
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m VERSION   :   1.1.2
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m WHATSAPP  :   +9779762902527
\33[1;37m--------------------------------------------""")
...
def menu():
	...
	if me in ["1", "01"]:
		...
		os.system('rm -rf Control-Room && git clone https://github.com/Dark_Devil/Dark_Devill&& cd Dark_Devil && python Dark_Devil.py ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [Dark_Devil] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
